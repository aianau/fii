...
/*1.Afisati toti studentii care au în an cu ei mãcar un coleg care sã fie mai mic ca ei (vezi data nasterii).*/
...
/*2.Afisati toti studentii care au media mai mare decât media tuturor studentilor din an cu ei. Pentru acestia afisati numele, prenumele si media lor.*/
...
/*3.Afisati numele, prenumele si grupa celui mai bun student din fiecare grupa în parte.*/
...
/*4.Gãsiþi toþi studenþii care au mãcar un coleg în acelaºi an care sã fi luat aceeaºi nota ca ºi el la mãcar o materie.*/
...
/*5.Afisati toti studentii care sunt singuri în grupã (nu au alti colegi în aceeasi grupã).*/
...
/*6.Afisati profesorii care au mãcar un coleg (profesor) ce are media notelor puse la fel ca si el.*/
--facem perechi
...
/*11.Afiºaþi numele si prenumele concatenate printr-un spatiu in coaloana "Student", anul, grupa, si media trunchiata la 2 zecimale
a celui mai slab student din fiecare grupa în parte(cea mai mica medie din grupa). Redenumiti coloana pentru medie cu "Medie"*/
