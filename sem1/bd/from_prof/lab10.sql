...
/*4.Identificati studentii a caror medie este mai mare decât media tuturor notelor din baza de date. Afisati numele si media acestora.*/  
...
limitarea numãrului de linii poate elimina studentii de pe pozitii egale; gãsiti altã solutie).*/
...
/*7.Afisati numele si prenumele tuturor studentilor care au luat aceeasi nota ca si Ciprian Ciobotariu la materia Logicã. 
Excludeþi-l pe acesta din listã.*/
