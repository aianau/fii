--1.Afi�a�i studen�ii �i notele luate de acestia precum si profesorii care le-au pus acele note.*/
...
--2.Afisati studen�ii care au luat nota 10 la materia 'BD'. 
--Singurele valori pe care ave�i voie s� le hardcoda�i �n interogare sunt valoarea notei (10) �i numele cursului ('BD').*/
...
--4.Modifica�i interogarea de la punctul 3 pentru a fi afi�a�i �i acei profesori care nu au �nc� alocat un curs.*/
...
--5.Modifica�i interogarea de la punctul 3 pentru a fi afi�ate acele cursuri ce nu au alocate �nc� un profesor.*/
select titlu_curs
...
--6.Modifica�i interogarea de la punctul 3 astfel �nc�t s� fie afi�a�i atat profesorii care nu au nici 
--un curs alocat c�t �i cursurile care nu sunt �nc� predate de nici un profesor*/
...
--7.In tabela studenti exist� studen�i care s-au nascut �n aceeasi zi a s�pt�m�nii. 
--De exemplu, Cobzaru George �i Pintescu Andrei s-au n�scut am�ndoi �ntr-o zi de marti.
--Construiti o list� cu studentii care s-au n�scut in aceea�i zi grup�ndu-i doi c�te doi �n ordine alfabetic� a numelor 
--(de exemplu in rezultat va apare combinatia Cobzaru-Pintescu dar nu va apare �i Pintescu-Cobzaru).
--Lista va trebui s� con�in� doar numele de familie a celor doi �mpreun� cu ziua �n care cei doi s-au n�scut. 
--Evident, dac� exist� �i al�i studenti care s-au n�scut marti, vor apare si ei in combinatie cu cei doi aminti�i mai sus. 
--Lista va fi ordonat� �n func�ie de ziua s�pt�m�nii �n care s-au n�scut si, �n cazul �n care sunt mai mult de trei studen�i n�scu�i �n aceea�i zi, 
--rezultatele vor fi ordonate �i dup� numele primei persoane din list�*/
...
--Dati un nume corespunzator coloanei [pont: interogarea trebuie s� returneze 118 r�nduri].*/
