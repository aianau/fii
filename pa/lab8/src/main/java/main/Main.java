...
public class Main {
    ...
    public static void testStudenti() {
        ...
        try {
            ...
            while (resultSet.next()) {
                String stringBuilder = resultSet.getString(1) +
                        " " +
    ...
    public static void test() {
        ...
        artistController.create(new Artist("Andrei", "Romanika"));
...
//        albumController.create("Andrei", 1999);
//        albumController.create("Gigi", 2008);
//        albumController.findByArtist(0);
